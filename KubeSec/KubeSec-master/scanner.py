...
run = Run(
    tool=Tool(
        driver=ToolComponent(
            name="SLI-KUBE",
            version="2.0.0",
            information_uri="https://github.com/paser-group/KubeSec",
            organization="PASER",
            rules=[],
        )
    )
...
run.results = []
slikube_01 = ReportingDescriptor(
    id="SLIKUBE_01",
    name=" Absent Resource Limit",
    short_description=Message(
        text="Specify resource limits for containers within a pod"
    ),
    full_description=Message(
        text="Specify resource limits for containers within a pod"
    ),
    help=Message(text="Specify resource limits for containers within a pod"),
    default_configuration=ReportingConfiguration(level="error"),
)
run.tool.driver.rules.append(slikube_01)
slikube_02 = ReportingDescriptor(
    id="SLIKUBE_02",
    name=" Absent securityContext",
    short_description=Message(
        text=" Use securityContext while provisioning containers"
    ),
    full_description=Message(text=" Use securityContext while provisioning containers"),
    help=Message(text=" Use securityContext while provisioning containers"),
    default_configuration=ReportingConfiguration(level="error"),
)
run.tool.driver.rules.append(slikube_02)
slikube_03 = ReportingDescriptor(
    id="SLIKUBE_03",
    name=" Activation of hostIPC",
    short_description=Message(
        text=" Deactivate hostIPC while specifying configurations in Kubernetes manifests"
    ),
    full_description=Message(
        text=" Deactivate hostIPC while specifying configurations in Kubernetes manifests"
    ),
...
slikube_04 = ReportingDescriptor(
    id="SLIKUBE_04",
    name=" Activation of hostNetwork",
    short_description=Message(
        text=" Deactivate hostNetwork while specifying configurations in Kubernetes manifests"
    ),
    full_description=Message(
        text=" Deactivate hostNetwork while specifying configurations in Kubernetes manifests"
    ),
...
slikube_05 = ReportingDescriptor(
    id="SLIKUBE_05",
    name=" Activation of hostPID",
    short_description=Message(
        text=" Deactivate hostPID while specifying configurations in Kubernetes manifests"
    ),
    full_description=Message(
        text=" Deactivate hostPID while specifying configurations in Kubernetes manifests"
    ),
...
slikube_06 = ReportingDescriptor(
    id="SLIKUBE_06",
    name=" Capability Misuse",
    short_description=Message(
        text=" Avoid misuse with CAP_SYS_ADMIN, and misuse with CAP_SYS_MODULE configurations"
    ),
    full_description=Message(
        text="Avoid misuse with CAP_SYS_ADMIN, and misuse with CAP_SYS_MODULE configurations"
    ),
...
slikube_07 = ReportingDescriptor(
    id="SLIKUBE_07",
    name=" Docker Socket Mounting",
    short_description=Message(
        text=" Avoid mounting of the Docker socket path by using the /var/run/docker.sock configuration"
    ),
    full_description=Message(
        text="Avoid mounting of the Docker socket path by using the /var/run/docker.sock configuration"
    ),
...
slikube_08 = ReportingDescriptor(
    id="SLIKUBE_08",
    name=" Escalated Privileges for Child Container Processes",
    short_description=Message(
        text=" Avoid allocating privileges for child processes within a container that are higher than that of the parent processes with allowPrivilegeEscaltion : true"
    ),
    full_description=Message(
        text=" Avoid allocating privileges for child processes within a container that are higher than that of the parent processes with allowPrivilegeEscaltion : true"
    ),
...
slikube_09 = ReportingDescriptor(
    id="SLIKUBE_09",
    name=" Hard-coded Secret",
    short_description=Message(
        text=" Avoid providing hard-coded secrets. Do not provide (i) hard-coded usernames, (ii) hard-coded passwords, and (iii) hard-coded private tokens in Kubernetes manifests."
    ),
    full_description=Message(
        text=" Avoid providing hard-coded secrets. Do not provide (i) hard-coded usernames, (ii) hard-coded passwords, and (iii) hard-coded private tokens in Kubernetes manifests."
    ),
...
slikube_10 = ReportingDescriptor(
    id="SLIKUBE_10",
    name=" Use of HTTP without TLS",
    short_description=Message(
        text=" Avoid using HTTP without SSL/TLS certificates to setup URLs or transmit traffic inside and outside the Kubernetes clusters"
    ),
    full_description=Message(
        text=" Avoid using HTTP without SSL/TLS certificates to setup URLs or transmit traffic inside and outside the Kubernetes clusters"
    ),
...
slikube_11 = ReportingDescriptor(
    id="SLIKUBE_11",
    name=" Privileged securityContext",
    short_description=Message(
        text="Avoid using privileged securityContext in Kubernetes manifests"
    ),
    full_description=Message(
        text="Avoid using privileged securityContext in Kubernetes manifests"
    ),
    help=Message(text="Avoid using privileged securityContext in Kubernetes manifests"),
    default_configuration=ReportingConfiguration(level="error"),
)
run.tool.driver.rules.append(slikube_11)
slikube_UNLISTED_01 = ReportingDescriptor(
    id="SLIKUBE_UNLISTED_01",
    name=" Use of Default Namespace",
    short_description=Message(text=" Avoid using the default namespace"),
    full_description=Message(text="  Avoid using the default namespace"),
    help=Message(text=" Avoid using the default namespace"),
    default_configuration=ReportingConfiguration(level="error"),
)
run.tool.driver.rules.append(slikube_UNLISTED_01)
slikube_UNLISTED_02 = ReportingDescriptor(
    id="SLIKUBE_UNLISTED_02",
    name=" No Use of Rolling Update",
    short_description=Message(text="  Use rolling update for deployment"),
    full_description=Message(text=" Use rolling update for deployment"),
    help=Message(text="Use rolling update for deployment"),
    default_configuration=ReportingConfiguration(level="error"),
)
run.tool.driver.rules.append(slikube_UNLISTED_02)
slikube_UNLISTED_03 = ReportingDescriptor(
    id="SLIKUBE_UNLISTED_03",
    name=" No Network Policy",
    short_description=Message(text=" Use network policy in pod specification"),
    full_description=Message(text=" Use network policy in pod specification"),
    help=Message(text="Use network policy in pod specification"),
    default_configuration=ReportingConfiguration(level="error"),
)
run.tool.driver.rules.append(slikube_UNLISTED_03)
slikube_UNLISTED_04 = ReportingDescriptor(
    id="SLIKUBE_UNLISTED_04",
    name=" Use of Host Aliases",
    short_description=Message(text="Avoid Using Host Aliases"),
    full_description=Message(text="Avoid Using Host Aliases"),
    help=Message(text="Avoid Using Host Aliases"),
    default_configuration=ReportingConfiguration(level="error"),
)
run.tool.driver.rules.append(slikube_UNLISTED_04)
slikube_UNLISTED_05 = ReportingDescriptor(
    id="SLIKUBE_UNLISTED_05",
    name=" Use of unconfined seccomp profile",
    short_description=Message(text=" Use Seccomp security profiles"),
    full_description=Message(text="  Use Seccomp security profiles"),
    help=Message(text=" Use Seccomp security profiles"),
    default_configuration=ReportingConfiguration(level="error"),
)
    ...
    for root_, dirs, files_ in os.walk(path_to_dir):
        for file_ in files_:
            ...
            if os.path.exists(full_p_file):
                if full_p_file.endswith(
                    constants.YML_EXTENSION
                ) or full_p_file.endswith(constants.YAML_EXTENSION):
...
def scanUserName(k_, val_lis):
    ...
    # Validate k_ is a string
    if not isinstance(k_, str):
        return hard_coded_unames
    k_ = k_.lower()

    # Validate val_lis is a list or tuple
    if not isinstance(val_lis, (list, tuple)):
        return hard_coded_unames
...
def scanPasswords(k_, val_lis):
    ...
    if isinstance(k_, str):
        k_ = k_.lower()
    if isValidPasswordName(k_) and any(
        x_ in k_ for x_ in constants.SECRET_PASSWORD_LIST
    ):
        for val_ in val_lis:
            if checkIfValidSecret(val_):
...
def scanForOverPrivileges(script_path):
    ...
    if checkVal:
        ...
        """
        # print(just_keys)
        if (constants.PRIVI_KW in just_keys) and (
            constants.DEAMON_KW not in kind_values
        ):
            privilege_values = []
            ...
            for value_ in privilege_values:
                if value_ == True:
                    ...
                    if (
                        (constants.CONTAINER_KW in key_lis_holder)
                        and (constants.SECU_CONT_KW in key_lis_holder)
                        and (constants.PRIVI_KW in key_lis_holder)
                    ):
                        key_count += 1
                        privi_dict_return[key_count] = value_, key_lis_holder
                        line_number = parser.show_line_for_paths(
                            script_path, constants.PRIVI_KW
                        )
                        for line in line_number:
                            result = Result(
                                ...
                                level="error",
                                attachments=[],
                                message=Message(text=" Privileged securityContext"),
                            )
                            location = Location(
                                physical_location=PhysicalLocation(
                                    artifact_location=ArtifactLocation(uri=script_path),
...
def scanSingleManifest(path_to_script):
    ...
    if checkVal:
        ...
        if (constants.CONFIGMAP_KW in val_lis) or (constants.SECRET_KW in val_lis):
            ...
            if len(key_lis) > 0:
                ...
                unique_keys = [
                    x_ for x_ in unique_keys if constants.KIND_KEY_NAME in x_
                ]
                if len(unique_keys) > 0:
                    dict_secret = scanForSecrets(yaml_dict)
                    within_secret_.append(
                        getItemFromSecret(dict_secret, 0)
                    )  # 0 for username
                    within_secret_.append(
                        getItemFromSecret(dict_secret, 1)
                    )  # 1 for password
                    within_secret_.append(
                        getItemFromSecret(dict_secret, 2)
                    )  # 2 for tokens
                else:
                    within_secret_.append({})
                    within_secret_.append({})
    ...
    for key in dict_secret:
        ...
        for line in line_number:
            print(line)
            secret, template_secret, valid_taint = graphtaint.mineSecretGraph(
                path_to_script, yaml_dict, dict_secret
            )
            ...
            result = Result(
                ...
                rule_index=8,
                level="error",
                attachments=[valid_taint],
                message=Message(text=" Hard-coded Secret"),
            )
            location = Location(
                physical_location=PhysicalLocation(
                    artifact_location=ArtifactLocation(uri=path_to_script),
                    region=Region(start_line=line),
                )
            )
            result.locations = [location]
    ...
    _, templ_secret_, valid_taint_secr = graphtaint.mineSecretGraph(
        path_to_script, yaml_dict, dict_secret
    )
...
def scanForMissingSecurityContext(path_scrpt):
    ...
    if parser.checkIfValidK8SYaml(path_scrpt):
        ...
        # print(real_key_lis)
        if (constants.SECU_CONT_KW not in real_key_lis) and (
            constants.CONTAINER_KW in real_key_lis
        ):
                    ...
                    if constants.KIND_KEY_NAME in pod_kw_lis:
                        ...
                        for line in line_number:
                            result = Result(
                                ...
                                level="error",
                                attachments=[],
                                message=Message(text=" Absent securityContext"),
                            )
                            location = Location(
                                physical_location=PhysicalLocation(
...
def scanForResourceLimits(path_scrpt):
    ...
    if parser.checkIfValidK8SYaml(path_scrpt):
        ...
        if constants.POD_KW in kind_entries:
            if (
                (constants.CONTAINER_KW in key_list)
                and (constants.LIMITS_KW not in key_list)
                and (
                    (constants.CPU_KW not in key_list)
                    or (constants.MEMORY_KW not in key_list)
                )
            ):
                cnt += 1
                ...
                for line in line_number:
                    result = Result(
                        ...
                        level="error",
                        attachments=[],
                        message=Message(text="  Absent Resource Limit"),
                    )
                    location = Location(
                        physical_location=PhysicalLocation(
                            artifact_location=ArtifactLocation(uri=path_scrpt),
...
def scanForRollingUpdates(path_script):
    ...
    if parser.checkIfValidK8SYaml(path_script):
        ...
        key_list = [x_[0] for x_ in temp_ls]
        if (
            (constants.STRATEGY_KW not in key_list)
            and (constants.ROLLING_UPDATE_KW not in key_list)
            and (constants.SPEC_KW in key_list)
        ):
            if len(temp_ls) > 0:
                all_values = list(parser.getValuesRecursively(yaml_di))
                # print(all_values)
                prop_value = constants.YAML_SKIPPING_TEXT
                if (constants.DEPLOYMENT_KW in all_values) and (
                    constants.VAL_ROLLING_UPDATE_KW not in all_values
                ):
                    ...
                    if constants.KIND_KEY_NAME in keyFromVal:
                        ...
                        line_number = parser.show_line_for_paths(
                            path_script, constants.SPEC_KW
                        )
                        for line in line_number:
                            result = Result(
                                rule_id="SLIKUBE_UNLISTED_02",
                                rule_index=12,
                                level="error",
                                attachments=[],
                                message=Message(text=" No Use of Rolling Update"),
                            )
                            location = Location(
                                physical_location=PhysicalLocation(
                                    artifact_location=ArtifactLocation(uri=path_script),
                                    region=Region(start_line=line),
                                )
                            )
                            result.locations = [location]
    ...
    if parser.checkIfValidK8SYaml(path_script):
        ...
        if constants.NET_POLICY_KW not in all_values:
            ...
            if constants.SPEC_KW in key_list:
                ...
                for line in line_number:
                    result = Result(
                        rule_id="SLIKUBE_UNLISTED_03",
                        rule_index=13,
                        level="error",
                        attachments=[],
                        message=Message(text=" No Use of Network Policy"),
                    )
                    location = Location(
                        physical_location=PhysicalLocation(
                            artifact_location=ArtifactLocation(uri=path_script),
            ...
            if (
                (constants.SPEC_KW in key_list)
                and (constants.POD_SELECTOR_KW in key_list)
                and (constants.MATCH_LABEL_KW in key_list)
            ):
                for src_val in all_values:
                    lis = graphtaint.mineNetPolGraph(
                        path_script, yaml_di, src_val, key_list
                    )
            dic[cnt] = lis
    # print(dic)
    return dic
    ...
    if parser.checkIfValidK8SYaml(path_script):
        ...
        if (constants.SPEC_KW in key_list) and (constants.HOST_PID_KW in key_list):
            ...
            if constants.TRUE_LOWER_KW in vals_for_pid:
                ...
                # For Sarif output
                line_number = parser.show_line_for_paths(
                    path_script, constants.HOST_PID_KW
                )
                for line in line_number:
                    result = Result(
                        rule_id="SLIKUBE_05",
                        ...
                        level="error",
                        attachments=[],
                        message=Message(text=" Activation of hostPID"),
                    )
                    location = Location(
                        physical_location=PhysicalLocation(
                            artifact_location=ArtifactLocation(uri=path_script),
    ...
    if parser.checkIfValidK8SYaml(path_script):
        ...
        if (constants.SPEC_KW in key_list) and (constants.HOST_IPC_KW in key_list):
            ...
            if constants.TRUE_LOWER_KW in vals_for_ipc:
                ...
                # For Sarif output
                line_number = parser.show_line_for_paths(
                    path_script, constants.HOST_IPC_KW
                )
                for line in line_number:
                    result = Result(
                        rule_id="SLIKUBE_03",
                        ...
                        level="error",
                        attachments=[],
                        message=Message(text=" Activation of hostIPC"),
                    )
                    location = Location(
                        physical_location=PhysicalLocation(
                            artifact_location=ArtifactLocation(uri=path_script),
    ...
    if parser.checkIfValidK8SYaml(path_script):
        ...
        if all(z_ in key_list for z_ in constants.DOCKERSOCK_KW_LIST):
            ...
            if constants.DOCKERSOCK_PATH_KW in all_values:
                cnt += 1
                docker_sock_path = parser.keyMiner(
                    yaml_di, constants.DOCKERSOCK_PATH_KW
                )
                ...
                line_number = parser.show_line_for_paths(
                    path_script, docker_sock_path[-2]
                )
                for line in line_number:
                    result = Result(
                        rule_id="SLIKUBE_07",
                        ...
                        level="error",
                        attachments=[],
                        message=Message(text=" Docker Socket Mounting"),
                    )
                    location = Location(
                        physical_location=PhysicalLocation(
                            artifact_location=ArtifactLocation(uri=path_script),
...
def runScanner(dir2scan):
    ...
    for yml_ in all_yml_files:
        ...
        if parser.checkIfWeirdYAML(yml_) == False:
            print("\n\n--------------- FILE --------------\n\t-->", yml_)
            if (
                (parser.checkIfValidK8SYaml(yml_)) or (parser.checkIfValidHelm(yml_))
            ) and parser.checkParseError(yml_):
                # print (" \n\n--------------- FILE RUNNING NOW---------------")
                # print (yml_)
                # print("---------------############################### ------\n\n\n")
                ...
                val_cnt = val_cnt + 1
                print(
                    constants.ANLYZING_KW
                    + yml_
                    + constants.COUNT_PRINT_KW
                    + yml_
                    + str(val_cnt)
                )

                print("get valid taint secrets")
                within_secret_, templ_secret_, valid_taint_secr = scanSingleManifest(
                    yml_
                )
                ...
                all_content.append(
                    (
                        ...
                        valid_taint_privi,
                        http_dict,
                        absentSecuContextDict,
                        defaultNameSpaceDict,
                        absentResourceDict,
                        rollingUpdateDict,
                        absentNetPolicyDic,
                        pid_dic,
    ...
    if parser.checkIfValidK8SYaml(path_script):
        ...
        if (constants.SPEC_KW in key_list) and (constants.HOST_NET_KW in key_list):
            ...
            if constants.TRUE_LOWER_KW in vals_for_net:
                cnt += 1
                line_number = parser.show_line_for_paths(
                    path_script, constants.HOST_NET_KW
                )
                for line in line_number:
                    result = Result(
                        rule_id="SLIKUBE_04",
                        ...
                        level="error",
                        attachments=[],
                        message=Message(text=" Activation of hostNetwork"),
                    )
                    location = Location(
                        physical_location=PhysicalLocation(
                            artifact_location=ArtifactLocation(uri=path_script),
            ...
            if constants.CAPSYS_ADMIN_STRING in relevant_values:
                ...
                for line in line_number:
                    result = Result(
                        ...
                        level="error",
                        attachments=[],
                        message=Message(text=" Capability Misuse"),
                    )
                    location = Location(
                        physical_location=PhysicalLocation(
                            artifact_location=ArtifactLocation(uri=path_script),
...
def scanForHostAliases(path_script):
    ...
    if parser.checkIfValidK8SYaml(path_script):
        ...
        if constants.HOST_ALIAS_KW in key_list:
            ...
            # Line number of the line where the key was found for CAPSYS_MODULE to provide  SARIF output
            line_number = parser.show_line_for_paths(
                path_script, constants.HOST_ALIAS_KW
            )
            for line in line_number:
                result = Result(
                    rule_id="SLIKUBE_UNLISTED_04",
                    rule_index=14,
                    level="error",
                    attachments=[],
                    message=Message(text=" Use of Host Aliases"),
                )
                location = Location(
                    physical_location=PhysicalLocation(
                        artifact_location=ArtifactLocation(uri=path_script),
...
def scanForAllowPrivileges(path_script):
    ...
    if parser.checkIfValidK8SYaml(path_script):
        ...
        if all(var in key_list for var in constants.ALLOW_PRIVI_KW_LIST):
            ...
            relevant_values = []
            parser.getValsFromKey(
                yaml_di, constants.ALLOW_PRIVILEGE_KW, relevant_values
            )
            relevant_values = [
                str(x_) for x_ in relevant_values if isinstance(x_, bool)
            ]
            relevant_values = [x_.lower() for x_ in relevant_values]
            if constants.TRUE_LOWER_KW in relevant_values:
                dic[cnt] = []
                line_number = parser.show_line_for_paths(
                    path_script, constants.ALLOW_PRIVILEGE_KW
                )
                for line in line_number:
                    # print(line7
                    result = Result(
                        ...
                        rule_index=7,
                        message=Message(
                            text="Escalated Privileges for Child Container Processes"
                        ),
                        level="error",
                    )
                    location = Location(
...
def scanForHTTP(path2script):
    ...
    http_count = 0
    if (
        parser.checkIfValidK8SYaml(path2script)
        or parser.checkIfValidHelm(path2script)
        or True
    ):
                ...
                if constants.SPEC_KW in just_keys:
                    ...
                    for line in line_number:
                        ...
                        result = Result(
                            ...
                            level="error",
                            attachments=[],
                            message=Message(text="Use of HTTP without TLS"),
                        )
                        location = Location(
                            physical_location=PhysicalLocation(
                                artifact_location=ArtifactLocation(uri=path2script),
                                region=Region(start_line=line),
                            )
                        )
                        result.locations = [location]
                    ...
                    infected_list = graphtaint.mineViolationGraph(
                        path2script, yaml_d, val_, key_
                    )
    ...
    if parser.checkIfValidK8SYaml(path_script):
        ...
        if all(var in key_list for var in constants.SECCOMP_KW_LIST):
            ...
            if constants.UNCONFIED_KW in relevant_values:
                line_number = parser.show_line_for_paths(
                    path_script, constants.UNCONFIED_KW
                )
                for line in line_number:
                    result = Result(
                        rule_id="SLIKUBE_UNLISTED_05",
                        rule_index=4,
                        level="error",
                        attachments=[],
                        message=Message(text=" Use of unconfined seccomp profile"),
                    )
                    location = Location(
                        physical_location=PhysicalLocation(
                            artifact_location=ArtifactLocation(uri=path_script),
